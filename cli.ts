...
const yargs = require("yargs")
	.usage(
		"Usage: $0 --init [--base={}] | --certs [options] | --keys [options]"
	)
	.describe(
		"init",
		"Creates an initial repository.  This option is mutuall exclusive to the others."
	)
	.default("init", false)
	.describe(
		"certs",
		"Creates a set of self signed certs in the repository for the given environment"
	)
	.default("certs", false)
	...
	.describe(
		"base",
		"A base directory whose contents will be copied into a new repository (with --init)"
	)
	.default("company", "NA")
	...
	.describe(
		"users",
		"A comma separated list of user names/ids associated with the RSA keys that will be created"
	)
	.version()
	.help()
